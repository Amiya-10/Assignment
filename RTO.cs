...
namespace Assignment_on_Collections
{
    class RTO
    {
                    ...
                    case 1:
                        {
                            ...
                            Console.Write("Enter the district number (ex-MH01/MH04): ");
                            ...
                            Console.WriteLine("\nThe district number and name has been added to the list\n");
                        }
                        break;
                    case 2:
                        {
                            ...
                            if (!exist)
                            {
                                Console.WriteLine("\nThe district number and name does not exist!\n");
                            }
                        }
                        break;
                    case 3:
